...
import { autoAssign, planSchedule, explainFailure } from "../../src/features/elective-plan/lib/scheduler.ts";
...
check("the bundled seed data plans, leaving only the deliberate failure case", () => {
  const rooms = JSON.parse(readFileSync("src/features/elective-plan/data/plan-rooms.json", "utf8")).rooms;
