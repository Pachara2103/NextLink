...
import { validateArchiveSessions, assertSeedNumber } from '../../src/features/elective-plan/lib/seed-validation.ts';
...
for (const id of ['2568-2', '2568-1', '2567-2']) {
  const archive = JSON.parse(readFileSync(`src/features/elective-plan/data/terms/${id}.json`, 'utf8'));
