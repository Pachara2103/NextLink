...
import { formatNumber, personName } from "@/features/elective-plan/lib/format";
import { placementBlockers } from "@/features/elective-plan/lib/scheduler.ts";
import { DAYS, DAY_LABELS, PERIODS, PERIOD_KEYS, makeSlotId, slotLabel, type SlotId } from "@/features/elective-plan/lib/slots.ts";
import type { Assignment, BlockerCode, PlanCourse, PlanRoom } from "@/features/elective-plan/lib/plan-types.ts";

/** The column for classes that occupy no room at all. */
const ONLINE_COLUMN = "__online__";
import type { Conflict } from "@/features/elective-plan/lib/conflicts.ts";
