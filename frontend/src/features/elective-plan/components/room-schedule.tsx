...
import { AssignDialog } from "@/features/elective-plan/components/assign-dialog";
import { BookingDialog, type BookingTarget } from "@/features/elective-plan/components/booking-dialog";
import { CourseChip } from "@/features/elective-plan/components/course-chip";
...
import { WeekGrid } from "@/features/elective-plan/components/week-grid";
import { formatNumber } from "@/features/elective-plan/lib/format";
import { slotLabel, type SlotId } from "@/features/elective-plan/lib/slots.ts";
    ...
    return (
      ...
      >
        <section className="panel">
          ...
          <Link className="secondary-button" href="/elective-plan/rooms">กลับไปหน้ารายชื่อห้อง</Link>
        </section>
      </PlanShell>
    );
  }
    ...
    >
      <div className="intro-row">
        <div>
          <p className="section-kicker">
            <Link className="text-button" href="/elective-plan/rooms">← ห้องเรียนทั้งหมด</Link>
          </p>
      ...
      <RoomDialog
        ...
        onDelete={async () => {
          ...
          router.push("/elective-plan/rooms");
          show(
            losing > 0
